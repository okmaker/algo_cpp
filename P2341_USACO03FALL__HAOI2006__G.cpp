//  Luogu contest  P2341 [USACO03FALL / HAOI2006] 受欢迎的牛 G
//  Created at 01.02.2026 17:47:05 in file P2341_USACO03FALL__HAOI2006__G.cpp
//  By zfq
#include <bits/stdc++.h>
// #include <bits/extc++.h>
#define LIMIT 22
...
void solve(){
    ...
    scc.run();
    vector<vector<int>> dag = scc.condense();
    int cnt = 0,id = 0;
